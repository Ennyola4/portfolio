  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-[#0a192f]">
      ...
      <div className="relative z-10 min-h-screen flex items-center">
        <div className="max-w-4xl mx-auto px-6 sm:px-8 md:px-12">
          ...
          <motion.h3
            ...
            className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold font-serif text-gray-400 mt-3 sm:mt-4"
          >
            I build things for the <span className="text-red-400">WEB</span>
          </motion.h3>
      ...
      <motion.div
        ...
        className="absolute bottom-10 sm:bottom-16 left-1/2 -translate-x-1/2 z-20 flex flex-col items-center text-[#64ffda]/40 text-xs sm:text-sm tracking-wide"
      >
